...
**DevPulse** is a single-page React application providing 21 developer utility tools, an integrated Gemini AI assistant, AI Bridge endpoints, and a markdown-driven Blog updates page. It runs entirely client-side (no backend) except for the optional Gemini API calls.
