...
DevPulse is a React 19 + TypeScript + Vite single-page app with 21 developer tools and one Gemini-based assistant tool.
...
- Runtime validation: `zod` (used in AI bridge + selected `src/lib/*` utilities)
