...
import { BadgeCheck, BadgeX, SearchCheck, Sparkles, Trash2, CreditCard, Info } from 'lucide-react';
            ...
            <div className="space-y-4">
              <div className="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-border/70 bg-muted/20 p-4">
                <div>
                  ...
                  <p className="text-lg font-mono font-semibold tracking-wide text-foreground">
                    {analysis.formatted}
                  </p>
                </div>
                <div
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                <div className="rounded-lg border border-border/70 p-3 bg-card/70">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    {analysis.personTypeDescription}
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-border/70 p-3 bg-card/70">
                  ...
                  <p className="mt-1 font-mono font-semibold text-foreground">
                    {analysis.actualChecksum}{' '}
                    <span className="text-muted-foreground">
                      (ควรเป็น {analysis.expectedChecksum})
                    </span>
                  </p>
                </div>
              </div>
