...
const UUIDGenerator: React.FC = () => {
    ...
    const handleChange = (key: keyof typeof options, value: any) => {
                            ...
                            <div className="space-y-4 pt-2">
                                <div className="flex items-center justify-between p-3 rounded-lg border border-border bg-card hover:bg-muted/30 transition-colors">
                                    <div className="space-y-0.5">
                                        <label className="text-sm font-medium cursor-pointer" htmlFor="hyphens-switch">Hyphens</label>
                                ...
                                <div className="flex items-center justify-between p-3 rounded-lg border border-border bg-card hover:bg-muted/30 transition-colors">
                                    <div className="space-y-0.5">
                                        <label className="text-sm font-medium cursor-pointer" htmlFor="uppercase-switch">Uppercase</label>
                ...
                <div className="lg:col-span-2 flex flex-col h-full gap-4">
                     <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-card p-4 rounded-xl border border-border shadow-sm">
                        ...
                        <div className="flex items-center gap-2">
                            {uuids.length > 0 && (
                                <>
                                    <Button variant="outline" size="sm" onClick={handleDownload} title="Download .txt">
