             ...
             <ToolLayout.Section title="External Tool">
                <Card className="border-indigo-500/20 shadow-lg bg-gradient-to-br from-indigo-50/50 to-background dark:from-indigo-950/10 dark:to-background overflow-hidden relative">
                     ...
                     <CardContent className="p-8 space-y-6 relative z-10">
                        ...
                        <Button asChild size="lg" className="w-full sm:w-auto h-12 px-8 text-base shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/30 hover:-translate-y-0.5 transition-all bg-indigo-600 hover:bg-indigo-700 text-white border-none">
                            <a 
                    ...
                    <CardContent className="p-6">
                            ...
                            {CRON_PARTS.map((part, i) => (
                                <div key={i} className="flex flex-col items-center gap-2 group cursor-default">
                                    ...
                                    <div className="text-center space-y-0.5">
                                        <div className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">{part.label}</div>
                        ...
                        <div className="bg-muted/30 rounded-lg p-4 text-xs text-muted-foreground border border-border/50">
                            ...
                            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 pl-6 list-disc marker:text-indigo-500/50">
                                <li><code className="bg-background px-1 rounded border border-border">*</code> any value</li>
                                <li><code className="bg-background px-1 rounded border border-border">,</code> value list separator</li>
                                <li><code className="bg-background px-1 rounded border border-border">-</code> range of values</li>
                                <li><code className="bg-background px-1 rounded border border-border">/</code> step values</li>
                            </ul>
                        </div>
                    </CardContent>
                </Card>
